  ...
  return (
    <section className="relative flex min-h-[calc(100vh-60px)] items-center border-b border-slate-300/80 dark:border-slate-800/80">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <h1 className="mt-4 max-w-4xl text-4xl font-bold leading-tight text-slate-900 dark:text-slate-100 sm:text-6xl">
          <span className="text-fuchsia-700 dark:text-fuchsia-300">{title}</span>
        </h1>
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-slate-700 dark:text-slate-300">{subtitle}</p>
      </div>
